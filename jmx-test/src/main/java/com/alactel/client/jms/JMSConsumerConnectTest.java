...
public class JMSConsumerConnectTest {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			// ConnectionFactory tempConnectionFactory = (ConnectionFactory)
			// context.lookup(DEFAULT_CONNECTION_FACTORY);
			// final org.hornetq.jms.client.HornetQConnectionFactory
			// srcCF=(HornetQConnectionFactory) tempConnectionFactory;
			...
			while (true) {
				try {
					...
					System.out.println("FailoverEventListener : "+fasListen);
					ExceptionListener exListen = srcConnect.getExceptionListener();
					System.out.println("ExceptionListener : "+exListen);
